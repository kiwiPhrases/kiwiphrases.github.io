...
To examine demographic patterns, I merge my block group level HHIs with ACS block group level data for Milwaukee County and regress the ACS data on HHIs<sup>[1](#myfootnote1)</sup>. I find that block groups with higher shares of units costing $10,000-$15,000, higher concentrations of renters, and more people per housing unit also tend to have higher market concentration. These figures suggest, though indirectly, that low-income areas with high renter shares are more likely to coincide with areas that have higher market concentrations. This could lead to low-income households being charged higher rents but I cannot test that directly yet without further data.
